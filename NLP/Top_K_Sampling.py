...
def summarize_text(input_text, model_name="t5-small", top_k=50):
    ...
    # Generate the summary using top-k sampling
    output_ids = model.generate(input_ids, max_length=150, top_k=top_k, temperature=1.0, do_sample=True, early_stopping=True)
    print(output_ids)
